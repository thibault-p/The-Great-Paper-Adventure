...
{
    /// <summary>
    /// Basic enemy : few life, no power, no danger + Hat
    /// </summary>
    public class PoulpiMarin : Poulpi
    {
        ...
        #region Sprite
        protected static Texture2D theBreizhSprite;

        public override Texture2D Sprite
        {
            get { return theBreizhSprite; }
        }

        public override void LoadContent(ContentManager cm)
        {
            theBreizhSprite = cm.Load<Texture2D>("gfx/Sprites/poulpiMarin");
        }
        #endregion
    }
}
